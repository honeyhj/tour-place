...
const SignUp = () => {
    ...
    return (
        <div>
            ...
            <div style={{width:'50%',margin:'auto',display:'flex',flexDirection:'column'}}>
                <form action="" onSubmit={handleSubmit}>
                        <div className="group">
                            ...
                            <input type="text" name="first name" onBlur={handleBlur} required/>
                        </div>
                        <div className="group">
                            <label htmlFor="name">Last Name</label><br />
                            <input type="text" name="last name" onBlur={handleBlur}/>
                        </div>
                    <div className="group">
            ...
            {/* <button onClick={handleFacebookSignIn}>Google Sign In</button> */}
            </div>
        </div>
    );
};
